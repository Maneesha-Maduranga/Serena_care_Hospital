        ...
        <AnimationSection side='-200'>
          <div className='flex flex-col  justify-items-center mb-0'>
            ...
            <p className='mt-4 md:mt-3'>
              ...
              every decision we make. From the moment you step through our
              doors, you will experience a warm and supportive environment where
            ...
            <p className='mt-4 md:mt-3'>
              ...
              Hospital. Contact us today to schedule an appointment or learn
              more about our services. Together, we can embark on a journey
